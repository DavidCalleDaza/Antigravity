...
async def list_products(
    ...
    try:
        logger.info(f"Fetching products: skip={skip}, limit={limit}, category_id={category_id}, status={status}")
        products = await get_products(db, skip=skip, limit=limit, category_id=category_id, status=status)
