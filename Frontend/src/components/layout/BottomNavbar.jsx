...
import { Package, Wrench, Leaf, UserCircle, FileText, BarChart3, Calendar, MoreHorizontal, X, Sprout } from 'lucide-react';
...
const MAIN_NAV_ITEMS = [
  ...
  { id: 'wall', label: 'Muro de Impacto', icon: Sprout, path: '/wall', allowedRoles: [ADMIN, SELLER, CLIENT] },
